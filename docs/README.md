# KnowledgeBaseApp — documentation
...
- [KB_APP_API_CONTRACT.md](KB_APP_API_CONTRACT.md) — KB App API paths + JSON (canonical for iOS ↔ FastAPI)
- [openapi/kb-app-api.yaml](openapi/kb-app-api.yaml) — OpenAPI subset (extend with backend)
...
- `docs/tasks/pending/` — planned work
- `docs/tasks/completed/` — finished task specs
